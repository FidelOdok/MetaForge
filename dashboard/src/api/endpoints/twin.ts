...
const MOCK_NODES: TwinNode[] = [
  { id: 'node-001', name: 'bracket-v1.step', type: 'work_product', domain: 'mechanical', status: 'valid', properties: { format: 'STEP', fileSize: 245000, material: 'Aluminum 6061' }, updatedAt: new Date(Date.now() - 2 * 3600_000).toISOString() },
  { id: 'node-002', name: 'main-schematic.kicad_sch', type: 'work_product', domain: 'electronics', status: 'valid', properties: { format: 'KiCad', sheets: 3 }, updatedAt: new Date(Date.now() - 4 * 3600_000).toISOString() },
  { id: 'node-003', name: 'pcb-layout.kicad_pcb', type: 'work_product', domain: 'electronics', status: 'warning', properties: { format: 'KiCad', layers: 4, drcErrors: 2 }, updatedAt: new Date(Date.now() - 1 * 3600_000).toISOString() },
  ...
  { id: 'node-006', name: 'firmware-main.c', type: 'work_product', domain: 'firmware', status: 'valid', properties: { format: 'C', lines: 1240 }, updatedAt: new Date(Date.now() - 12 * 3600_000).toISOString() },
  { id: 'node-007', name: 'enclosure-v2.step', type: 'work_product', domain: 'mechanical', status: 'valid', properties: { format: 'STEP', fileSize: 580000, material: 'ABS' }, updatedAt: new Date(Date.now() - 24 * 3600_000).toISOString() },
  ...
  { id: 'node-010', name: 'BOM export', type: 'work_product', domain: 'manufacturing', status: 'valid', properties: { format: 'CSV', components: 42 }, updatedAt: new Date(Date.now() - 3 * 3600_000).toISOString() },
];
