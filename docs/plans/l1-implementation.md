...
|---|---|---|---|---|---|---|---|---|
| L1-A1 | Project isolation enforcement | MET-401 | M | — | ⏳ | — | — | TODO at lightrag_service.py:235–276 |
...
| L1-C2 | CLI error reporting on bad input | MET-411 | XS | — | ⏳ | — | — | KB-CLI-005, KB-CLI-006 |
...
| L1-F1 | Author 26 NEW kb-test-plan rows | MET-410 | L | — | ⏳ | — | — | scenarios from §1–§10 |
