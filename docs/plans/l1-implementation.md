...
| L1-F3 | Dual-project isolation integration test | MET-401 | S | L1-A1 | ⏸️ | test/met-401-project-isolation | [#186](https://github.com/FidelOdok/MetaForge/pull/186) | 2/4 tests added; blocked: `delete_by_source` and supersede ignore project_id (real L1-A1/A6 gaps); needs API change |
