...
echo "  forge <cmd>    -> scriptable commands (forge --help)"
echo "The niche Python-only commands (codex-login, routine, ingest-datasheet)"
echo "ship separately as 'forge-legacy-<os>' on the Releases page."
